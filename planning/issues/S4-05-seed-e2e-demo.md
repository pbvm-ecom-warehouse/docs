...
**Sprint:** 4 · **Size:** L · **Depends-on:** S2-04, S3-01

## Bối cảnh
Chốt chất lượng: kịch bản end-to-end chạy được từ seed, demo luồng WMS hoàn chỉnh. Đây là việc cuối, gom cả đội.

## Phạm vi
- [ ] Seed script: kho trung tâm (1 kho) + zone/rack/shelf (có kích thước), vài WarehouseItem (MATERIAL/CUP_BLANK), 1 supplier + bảng giá, users mọi role.
